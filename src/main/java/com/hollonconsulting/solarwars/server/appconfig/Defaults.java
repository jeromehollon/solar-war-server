...
public class Defaults {
    ...
    public static final int MAX_GALACTIC_DISTANCE = 5000;
    public static final int MAX_STAR_DISTANCE = 300;
    public static final int MIN_STAR_DISTANCE = 100;
    public static final int MAX_PLANET_DISTANCE_FROM_STAR = 60;
    public static final int MIN_PLANET_DISTANCE_FROM_STAR = 15;
